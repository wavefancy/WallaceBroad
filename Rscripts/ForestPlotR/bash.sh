...
# Work in Broad MAC forestplot ENV.

 cat ./two_line_title_group.txt | Rscript ./ForestPlot.Middle.R -o two_line_title_group.pdf -W 9 -H 4.5 -g GROUP --pfl g && open two_line_title_group.pd
